...
data class GatewayProperties(
    ...
    val profileServiceBaseUrl: String = "http://profile-service:8091",
    ...
    val mobileWebOrigins: String =
        "http://localhost:3000,http://host.docker.internal:3000,http://localhost:3001,http://host.docker.internal:3001,http://localhost:3002,http://host.docker.internal:3002,http://localhost:3004,http://host.docker.internal:3004",
